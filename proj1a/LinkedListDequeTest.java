...
public class LinkedListDequeTest {
	...
	public static void getRecursiveTest() {
		...
		lld1.addFirst("front");
		passed = checkGetRecursive("front", lld1.getRecursive(0)) && passed;

		lld1.addLast("middle");
		passed = checkGetRecursive("middle", lld1.getRecursive(1)) && passed;

		lld1.addLast("back");
		passed = checkGetRecursive("back", lld1.getRecursive(2)) && passed;
